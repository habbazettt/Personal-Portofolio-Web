    ...
    return (
        <div className="container mx-auto min-h-screen grid grid-cols-1 md:grid-cols-2  px-8 md:px-24 justify-between items-center py-10 bg-primary">
            <div className="order-last xl:order-first ">
                ...
                <h1 className="text-2xl text-left md:text-4xl font-bold text-secondary mt-1">Front End Developer & UI/UX Designer</h1>
                <p className="text-sm text-left md:text-xl  text-white mt-3">
                    A Computer Science student who specialize in designing and building immersive website using the latest frontend technologies and frameworks to bring your vision to life.
                </p>
